...
s = s.replace("import SupervisorFeedbackView from './SupervisorFeedbackView';", "import SupervisorFeedbackView from './SupervisorFeedbackView';\nimport SupervisorCommunicationView from './SupervisorCommunicationView';\nimport SupervisorResponseView from './SupervisorResponseView';");
s = s.replace("  const [colaboradores, setColaboradores] = useState([]);", "  const [colaboradores, setColaboradores] = useState([]);\n  const [supervisores, setSupervisores] = useState([]);");
